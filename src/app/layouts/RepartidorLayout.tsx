  ...
  return (
    <div className="min-h-screen bg-zinc-900 text-white">
      <header
        ...
        style={{ backgroundColor: "#1d4ed8" /* azul-700 */ }}
      >
        <div className="w-full px-6 flex items-center justify-between py-3">
          ...
          <nav className="flex items-center gap-6">
            <Link to="/repartidor" className={isActive("/repartidor")}>
              Asignados
            </Link>
            <Link
              to="/repartidor/disponibles"
              className={isActive("/repartidor/disponibles")}
            >
              Disponibles
            </Link>
            <Link
              to="/repartidor/historial"
              className={isActive("/repartidor/historial")}
            >
              Historial
            </Link>
